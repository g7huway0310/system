...
public class OrderDAOImp implements OrderDAO {
	...
	public void addOrder(Order order) {
		...
		String sqlOrder="insert into ORDERS"
				...
				+ " INVOICETITLE,ORDERSTATUS,ORDERDATE) "
				+ " values(?,?,?,?,?,?)";
		String sqlOrderitems="Insert Into OrderItems (orderNo, PRODUCT_ID,"
		...
		try(
	    PreparedStatement psmt = con.prepareStatement(sqlOrder,generatedColumns)){
