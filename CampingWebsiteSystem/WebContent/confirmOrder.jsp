...
<body>
	<FORM style="margin: 0 auto; width: 700px;"
		action="<c:url value='ProcessOrderServlet' />" method="POST">
		<table border='1'>
			<tr>
				...
				<td border-style: ridge;>出貨地址:<input type="text" name="SHIPPINGADDRESS" id="SHIPPINGADDRESS"> </td>
				<td border-style: ridge;>發票 <input type="text" name="invoiceTitle"></input> </td>
			</tr>
		</table>
		<table border='1'>
			<tr>
